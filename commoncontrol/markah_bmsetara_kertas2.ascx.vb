...
Public Class markah_bmsetara_kertas2
    ...
    Private Function getSQL() As String
        ...
        Dim strGroup As String = " GROUP BY  kpmkv_pelajar.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu2,kpmkv_pelajar_markah.Catatan2  "

        '--not deleted
        tmpSQL = "SELECT kpmkv_pelajar.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu2,kpmkv_pelajar_markah.Catatan2 FROM kpmkv_pelajar"
        ...
        Dim strGroup1 As String = " GROUP BY  kpmkv_pelajar_ulang.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu2,kpmkv_pelajar_markah.Catatan2 "
        Dim strOrder1 As String = " ORDER BY kpmkv_pelajar.AngkaGiliran ASC"

        tmpSQL1 = "SELECT kpmkv_pelajar_ulang.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu2,kpmkv_pelajar_markah.Catatan2 "
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                Dim A_BahasaMelayu2 As TextBox = datRespondent.Rows(i).FindControl("A_BahasaMelayu2")
                Dim Catatan2 As TextBox = datRespondent.Rows(i).FindControl("Catatan2")

                'assign value to integer
                Dim strMarkah As String = A_BahasaMelayu2.Text
                Dim strCatatan As String = Catatan2.Text


                strSQL = "UPDATE kpmkv_pelajar_markah SET A_BahasaMelayu2='" & strMarkah & "', Catatan2='" & strCatatan & "' WHERE kpmkv_pelajar_markah.PelajarID='" & strPelajarID & "'"
    ...
    Private Function ValidateForm() As Boolean
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            Dim Kertas2 As TextBox = CType(row.FindControl("A_BahasaMelayu2"), TextBox)
            ...
            '--strBahasaMelayu3
            If Not Kertas2.Text.Length = 0 Then
                'If oCommon.IsCurrency(Kertas2.Text) = False Then
                '    Return False
                'End If
                If CInt(Kertas2.Text) > 110 Then
                    Return False
                End If
            Else
                Kertas2.Text = "0"
