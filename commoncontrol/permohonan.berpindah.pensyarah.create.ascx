<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="permohonan.berpindah.pensyarah.create.ascx.vb" Inherits="kpmkv.permohonan_berpindah_pensyarah_create" %>
<table class="fbform">
