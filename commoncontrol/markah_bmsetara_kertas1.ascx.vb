...
Public Class markah_bmsetara_kertas1
    ...
    Private Function getSQL() As String
        ...
        Dim strGroup As String = " GROUP BY kpmkv_pelajar.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu1,kpmkv_pelajar_markah.Catatan"

        '--not deleted
        tmpSQL = "SELECT kpmkv_pelajar.PelajarID,kpmkv_pelajar.AngkaGiliran,kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu1,kpmkv_pelajar_markah.Catatan FROM kpmkv_pelajar"
        tmpSQL += " LEFT OUTER JOIN kpmkv_pelajar_markah ON kpmkv_pelajar_markah.PelajarID=kpmkv_pelajar.PelajarID"
        strWhere = " WHERE kpmkv_pelajar.IsDeleted='N' AND kpmkv_pelajar.StatusID='2' AND kpmkv_pelajar.IsCalon='1' AND kpmkv_pelajar.Semester ='4'"
        strWhere += " AND kpmkv_pelajar.KolejRecordID ='" & lblKolejRecorID.Text & "'"
        strWhere += " AND kpmkv_pelajar.IsBMTahun ='" & lblTahun.Text & "'"
        ...
        Dim strGroup1 As String = " GROUP BY  kpmkv_pelajar_ulang.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu1,kpmkv_pelajar_markah.Catatan "
        Dim strOrder1 As String = " ORDER BY kpmkv_pelajar.AngkaGiliran ASC"

        tmpSQL1 = "SELECT kpmkv_pelajar_ulang.PelajarID, kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,kpmkv_pelajar_markah.A_BahasaMelayu1,kpmkv_pelajar_markah.Catatan"
        ...
        tmpSQL1 += " LEFT OUTER JOIN kpmkv_pelajar_markah ON kpmkv_pelajar_markah.PelajarID=kpmkv_pelajar_ulang.PelajarID"
        strWhere1 = " WHERE kpmkv_pelajar_ulang.IsCalon='1' AND kpmkv_pelajar_ulang.Semester ='4' AND kpmkv_pelajar_ulang.NamaMataPelajaran='BAHASA MELAYU'"
        strWhere1 += " AND kpmkv_pelajar_ulang.KolejRecordID ='" & lblKolejRecorID.Text & "'"
        strWhere1 += " AND kpmkv_pelajar_ulang.IsBMTahun ='" & lblTahun.Text & "'"
        strWhere1 += " AND kpmkv_pelajar_ulang.Sesi ='" & lblSesi.Text & "'"
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                Dim A_BahasaMelayu1 As TextBox = datRespondent.Rows(i).FindControl("A_BahasaMelayu1")
                Dim Catatan As TextBox = datRespondent.Rows(i).FindControl("Catatan")

                'assign value to integer
                Dim BM3 As String = A_BahasaMelayu1.Text
    ...
    Private Function ValidateForm() As Boolean
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            Dim A_BahasaMelayu1 As TextBox = CType(row.FindControl("A_BahasaMelayu1"), TextBox)
            Dim Catatan As TextBox = CType(row.FindControl("Catatan"), TextBox)

            '--validate NUMBER and less than 130
            '--strBahasaMelayu

            '--strBahasaMelayu3
            If Not A_BahasaMelayu1.Text.Length = 0 Then
                ''If oCommon.IsCurrency(Kertas1.Text) = False Then
                ''    Return False
                ''End If
                If CInt(A_BahasaMelayu1.Text) > 130 Then
                    Return False
                End If
            Else
                A_BahasaMelayu1.Text = "0"
            End If

            '--strBahasaMelayu3
            If Not Catatan.Text.Length = 0 Then
                ''If oCommon.IsCurrency(Kertas1.Text) = False Then
                ''    Return False
                ''End If
                If CInt(Catatan.Text) > 130 Then
                    Return False
                End If
            Else
                Catatan.Text = "0"
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            'myTable.HorizontalAlignment = Rectangle.NO_BORDER
            Dim intTblWidth() As Integer = {10, 36, 36, 10, 36}
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                Dim intTblCell8() As Integer = {10, 36, 36, 10, 36}
