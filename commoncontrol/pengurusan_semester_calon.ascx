<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pengurusan_semester_calon.ascx.vb" Inherits="kpmkv.pengurusan_semester_calon1" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
         <td>Pindah Calon Ke Semester :
        <asp:DropDownList ID="ddlSemesterTransfer" runat="server" AutoPostBack="false" Width="200px"> </asp:DropDownList></td>
     </tr>
    <tr>
