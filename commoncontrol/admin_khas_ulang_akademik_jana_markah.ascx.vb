...
Public Class admin_khas_ulang_akademik_jana_markah
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += " AND IsAKASesi ='" & chkSesi.Text & "'"
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            Dim myPara05 As New Paragraph("PENTAKSIRAN PUSAT " & "SESI, " & chkSesi.Text & ", " & ddlTahun.Text, FontFactory.GetFont("Arial", 10, Font.BOLD))
            ...
            Dim strKodPusat As String = oCommon.getFieldValue(strSQL)


            Dim Cell2TTL As New PdfPCell(New Phrase("" & strKodPusat, FontFactory.GetFont("Arial", 9, Font.NORMAL)))
