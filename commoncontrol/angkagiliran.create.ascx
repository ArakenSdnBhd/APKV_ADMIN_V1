<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="angkagiliran.create.ascx.vb" Inherits="kpmkv.angkagiliran_create" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td colspan="2"><asp:Button ID="btnAngkagiliran" runat="server" Text="Jana AngkaGiliran" CssClass="fbbutton" />&nbsp;<asp:Button ID="btnBatal" runat="server" Text="Batal AngkaGiliran" CssClass="fbbutton" /></td>
           </tr>
     <tr>
        <td colspan="2">
        </td>
