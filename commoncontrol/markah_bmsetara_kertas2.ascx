<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_bmsetara_kertas2.ascx.vb" Inherits="kpmkv.markah_bmsetara_kertas2" %>
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kertas 2">
                        <ItemTemplate>
                            <asp:TextBox ID="A_BahasaMelayu2" runat="server" Width="30px" Text='<%# Bind("A_BahasaMelayu2")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
