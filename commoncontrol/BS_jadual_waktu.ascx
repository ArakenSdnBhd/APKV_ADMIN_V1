<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="BS_jadual_waktu.ascx.vb" Inherits="kpmkv.BS_jadual_waktu" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Bank Soalan >> Jadual Waktu >> </td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Maklumat Jadual Waktu</td>
    </tr>
     <tr>
    ...
    <tr>
        <td style="width: 20%;">Catatan:</td>
         <td><asp:TextBox ID="txtDesc" runat="server"  Height="70px" Rows="1" TextMode="MultiLine" Width="737px"></asp:TextBox></td>
    <tr>
       <td style="width: 20%;">Tarikh Mula:</td>
         <td><asp:TextBox ID="txtDateStart" ReadOnly = "true" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
       <td style="width: 20%;">Tarikh Akhir:</td>
         <td><asp:TextBox ID="txtDateEnd" ReadOnly = "true" runat="server"></asp:TextBox></td>
    </tr>
    </table>
<br />
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Jadual Waktu
        </td>
    </tr>
    <tr>
        <td colspan="2">
