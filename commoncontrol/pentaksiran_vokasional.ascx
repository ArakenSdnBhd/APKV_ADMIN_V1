<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksiran_vokasional.ascx.vb" Inherits="kpmkv.pentaksiran_vokasional" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td style="text-align: center;">&nbsp;<asp:Button ID="btnPrint" runat="server" Text="Cetak Laporan Akhir" CssClass="fbbutton" />&nbsp;<asp:HyperLink ID="hyPDF" runat="server" Target="_blank"
