    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                strSQL = "UPDATE kpmkv_pelajar_markah SET A_BahasaMelayu='" & BM & "', A_BahasaMelayu1='" & BM1 & "', A_BahasaMelayu2='" & BM2 & "', "
                ...
                strSQL += " WHERE KolejRecordID='" & ddlKolej.SelectedValue & "' AND PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
