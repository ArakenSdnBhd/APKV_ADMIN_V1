<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="sijil_vok_malaysia.ascx.vb" Inherits="kpmkv.sijil_vok_malaysia1" %>
<table class="fbform">
...
<table class="fbform" style="width: 100%">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:Button ID="btnKemaskini" runat="server" Text="Kemaskini" CssClass="fbbutton" /></td>
    </tr>
</table>
<br />
<table class="fbform" style="width: 100%">
